            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@resilienthumancollective.org" className="text-royal-green hover:underline">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Distributed across bioregions</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-light-green rounded-xl p-6">
                ...
                <p className="text-gray-600 mb-4 text-sm">
                  Logos, brand guidelines, and organizational information for media and partners.
                </p>
      ...
      <section className="py-20 bg-light-purple">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-8">
            Schedule a call with our team to discuss partnerships, collaborations, 
            or how to bring resilient practices to your community.
          </p>
